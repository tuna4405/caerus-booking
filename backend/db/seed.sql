...
INSERT INTO events (title, description, starts_at, duration_minutes, auditorium, price) VALUES
  ('Inside Out 2',   'Animated feature.',       '2026-08-30T19:30:00Z',  96, 'Room 1',  90000),
  ('Dune: Part Two', 'Sci-fi epic.',            '2026-08-30T21:00:00Z', 166, 'Room 2', 120000),
  ('The Old Guard',  'Action.',                 '2026-08-31T18:00:00Z', 125, 'Room 1',  90000);
